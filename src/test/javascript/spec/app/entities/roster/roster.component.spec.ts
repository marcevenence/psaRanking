...
import { RosterComponent } from 'app/entities/roster/roster.component';
import { RosterService } from 'app/entities/roster/roster.service';
import { Roster } from 'app/shared/model/roster.model';

describe('Component Tests', () => {
  describe('Roster Management Component', () => {
    let comp: RosterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RosterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rosters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
