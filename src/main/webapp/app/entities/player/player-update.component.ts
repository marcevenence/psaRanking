...
export class PlayerUpdateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.personService
      .query()
      .subscribe((res: HttpResponse<IPerson[]>) => (this.people = res.body), (res: HttpErrorResponse) => this.onError(res.message));
    this.rosterService
      .query()
      .subscribe((res: HttpResponse<IRoster[]>) => (this.rosters = res.body), (res: HttpErrorResponse) => this.onError(res.message));
  }
